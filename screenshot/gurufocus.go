...
func makeScreenshotForGuruFocus(linkURL string, x, y, width, height float64, quality int64, res *[]byte) chromedp.Tasks {
	...
	return chromedp.Tasks{
		...
		// // TODO: никак не подлезть к этой кнопке - видимо она появляется позже
		// // chromedp.SetAttributeValue(selMoreMarginSection+" > div > div.note-button", "style", "display:none"),
