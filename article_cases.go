...
var ArticleCases = []ArticleCase{
	...
	{name: "stockscores.com", linkURL: "https://stockscores.com/charts/charts/?ticker=%s",
		...
		// width:          800,
		// height:         600,
		// imageURL:       "https://www.stockscores.com/chart.asp?TickerSymbol=%s&TimeRange=30&Interval=d&ChartType=CandleStick&ChartWidth=600&ChartHeight=300&LogScale=None&candles=redgreen%5B/img%5D",
		width:    2850,
		height:   1440,
		imageURL: "https://www.stockscores.com/chart.asp?TickerSymbol=%s&TimeRange=180&Interval=d&Volume=1&ChartType=CandleStick&Stockscores=None&ChartWidth=600&ChartHeight=300&LogScale=None&Band=None&avgType1=EMA&movAvg1=20&avgType2=EMA&movAvg2=100&Indicator1=RSI&Indicator2=None&Indicator3=MACD&Indicator4=AccDist&CompareWith=&entryPrice=&stopLossPrice=&candles=redgreen",
